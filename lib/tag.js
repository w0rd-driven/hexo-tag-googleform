 ...
 *
 * Examples:
 *   {% googleform dGVfY3MwcklDcjVrZERGYlRoZWdnpmJQnc6MQ Thank you. I'll get back to you shortly %}
 */
...
function googleFormTag(args) {
  ...
  return requestPromise(options)
    ...
    .catch(function(err) {
      return 'Error fetching form, expected syntax: {% googleform formkey [message] %}';
    });
}
